...
export const metadata: Metadata = {
  title: "Disclaimer | Slow Namibia",
  description: "Disclaimer for Slow Namibia travel services.",
};
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              The information provided on the Slow Namibia website is for general 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              requirements with official sources before traveling. Slow Namibia is not 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              Slow Namibia is not liable for any illness, injury, or loss that may occur 
              during your journey.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              In no event shall Slow Namibia be liable for any indirect, incidental, 
