...
export const metadata: Metadata = {
  title: "Health & Safety | Slow Namibia",
  description: "Health and safety information for traveling to Namibia.",
};
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-32 pb-24">
      <div className="container mx-auto px-6 lg:px-16 max-w-3xl">
        ...
        <p className="text-white/50 mb-12 text-lg">
          Namibia is a safe destination for travelers. Here's what you need to know 
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              Namibia can be hot, especially in summer and in desert regions. Stay 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed mb-4">
              Namibia is welcoming to tourists. Common sense precautions apply:
            </p>
            <ul className="space-y-3 text-white/50">
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              Women travel safely throughout Namibia. Modest dress is appreciated, 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              We monitor conditions throughout Namibia and will adjust itineraries if 
