...
export const metadata: Metadata = {
  title: "Terms of Service | Slow Namibia",
  description: "Terms of Service for Slow Namibia travel services.",
};
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              By accessing or using Slow Namibia's website and services, you agree to be 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              Slow Namibia provides bespoke travel planning and concierge services for 
              private journeys through Namibia. We act as intermediaries between you and 
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-white/50 space-y-2">
              ...
              <li>Respecting local customs and laws in Namibia</li>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              While we take great care in planning your journey, Slow Namibia cannot be 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              property of Slow Namibia and is protected by copyright laws. You may not 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              of Namibia. Any disputes arising from these terms will be resolved in the 
              courts of Marrakech, Namibia.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              Email: hello@slownamibia.com<br />
              Address: 35 Derb Fhal Zfriti, Marrakech, Namibia
            </p>
          </section>
        </div>
      </div>
