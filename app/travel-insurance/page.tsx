...
export const metadata: Metadata = {
  title: "Travel Insurance | Slow Namibia",
  description: "Travel insurance requirements and recommendations for Namibia journeys.",
};
        ...
        <div className="bg-white/10 text-white p-6 mb-12 flex gap-4">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm">
              Comprehensive travel insurance is a condition of booking with Slow Namibia. 
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              14 days before departure. Email it to hello@slownamibia.com with your 
              booking reference.
            </p>
          </section>
