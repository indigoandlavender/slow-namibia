...
export const metadata: Metadata = {
  title: "Visa Information | Slow Namibia",
  description: "Visa requirements and travel documentation for visiting Namibia.",
};
        ...
        <div className="space-y-12">
          <section>
            ...
            <p className="text-white/50 leading-relaxed mb-6">
              Citizens of many countries can enter Namibia without a visa for stays up to 
          ...
          <section>
            ...
            <ul className="space-y-3 text-white/50">
              <li>• Passport must be valid for at least 6 months beyond your planned departure from Namibia</li>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              Upon arrival in Namibia, you'll need to complete an entry card with your 
              ...
              your Slow Namibia itinerary confirmation can be helpful.
            </p>
          </section>
